          ...
          children: [
            ...
            Center(
              ...
              child: Column(
                children: [
                  SizedBox(height: 30,
                  child: Text("CHHAL 3ANDO", style: TextStyle(
                          color: Palette.backgroundColor,
                          fontSize: 18,
                          fontWeight: FontWeight.w300,
                  )),),
                  SizedBox(height: 90,
                  child:Text("-40 DH", style: TextStyle(
                          ...
                          Container(
                              ...
                              child: new Center(
                                child: new IconButton(
                                  onPressed: () {  },
                                  icon: Image.asset("assets/images/ysalef.png"),
                                ),
                              )),
                          Text("YSALEF", style: TextStyle(
                            color: Palette.backgroundColor,
                            fontSize: 13,
                          ),)
                        ]),
